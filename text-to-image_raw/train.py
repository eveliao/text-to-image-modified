...
def main():
    ...
    parser.add_argument('--t_dim', type=int, default=88,
    ...
    parser.add_argument('--df_dim', type=int, default=22,
    ...
    with tf.variable_scope(tf.get_variable_scope(), reuse=None):
        d_optim = tf.train.GradientDescentOptimizer(args.learning_rate).minimize(loss['d_loss'],
...
def load_training_data(data_dir, data_set):
    if data_set == 'flowers':
        ...
        print ("len of training image list")
